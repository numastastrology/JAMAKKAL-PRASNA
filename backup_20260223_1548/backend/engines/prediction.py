...
class PredictionEngine:
    ...
    def generate_full_report_data(self, lang: str = "en"):
        ...
        if self.intent == "CAREER":
            ...
            favour = "positive with steady progress" if kav_rel in [5, 9, 11] else "requiring patience and right timing"
            final = (
                f'The Jamakkal Prasna analysis regarding "{query_ctx}" indicates the outcome is {favour}. '
            ...
            final = (
                f'The Jamakkal Prasna analysis regarding "{query_ctx}" indicates that {favour}. '
            ...
            final = (
                f'The Jamakkal Prasna analysis regarding "{query_ctx}" indicates the configuration is {favour}. '
