...
def test_precision():
    ...
    print('--- RAW DATA ---')
    print(f"Udayam: {engine.udayam}")
    print(f"Arudam: {engine.arudam}")
    print(f"Kavippu: {engine.kavippu}")
    print(f"Ruling Planet: {engine.ruling_planet}")
    
    print('--- REASONING BA ---')
    print(res.get('bat_first_score_reason'))
    print('--- REASONING BB ---')
    print(res.get('bat_second_score_reason'))
