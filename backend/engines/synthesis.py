...
class SynthesisEngine:
    ...
    def _calculate_cricket_prediction(self):
        ...
        is_high_scoring_geo = (
            ...
            (18.8 <= lat <= 19.1 and 72.7 <= lon <= 72.9) or # Mumbai
            (12.9 <= lat <= 13.1 and 77.5 <= lon <= 77.7) or # Bangalore
            (22.5 <= lat <= 22.7 and 88.3 <= lon <= 88.5) or # Kolkata
            (13.0 <= lat <= 13.2 and 80.2 <= lon <= 80.4)    # Chennai
        )
