...
print("=" * 70)
print("CRICKET PREDICTION VERIFICATION — NZ vs ENG (6.45 PM)")
print("=" * 70)

# Exact match details from user query
je = JamakkalEngine(23.0225, 72.5714, datetime(2026, 2, 27, 18, 45, 0))
jd = je.compute_all()
qt = 'WHO WILL WIN TODAYS CRICKET MATCH BETWEEN NEW ZEALAND AND ENGLAND'
jd['query_text'] = qt
...
if cd:
    print(f"\nUdayam={se.udayam}")
    print(f"Team A (Lagna): {cd['team_a']}")
    print(f"Team B (7th): {cd['team_b']}")
